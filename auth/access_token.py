...
def get_encoded_credentials():
    try:
        ...
        return encoded_credentials.decode('ascii')
    except ValueError as e:
...
def get_access_token():
    print(f"client_id being used: {get_client_id_from_file()}")
    print(f"code being used: {get_code_from_url()}")
    print(f"encoded credentials: {get_encoded_credentials()}")
    print(f"payload: {get_payload()}")
